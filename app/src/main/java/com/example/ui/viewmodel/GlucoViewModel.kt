                        ...
                        if (savedPassword != null && savedPassword == password) {
                            ...
                            viewModelScope.launch {
                                ...
                                try {
                                    ...
                                    android.util.Log.e("GlucoViewModel", "Error saving profile: ${ex.message}")
                                }
                            }
                            android.widget.Toast.makeText(getApplication(), "Successfully authorized (cached credentials)!", android.widget.Toast.LENGTH_SHORT).show()
                        } else {
