    ...
    fun login(username: String, password: String, rememberMeChecked: Boolean = false): Boolean {
        ...
        if (trimmed == "admin") {
            ...
            if (savedPassword == null) {
                ...
                // Clear any auto-generated dummy data so they start with empty clinical records
                clearOnlyAutoGeneratedDummyData()

                // Dynamically update the patient name on every new login session
                viewModelScope.launch {
            ...
            try {
                ...
                if (connection.responseCode == 200) {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        if (tagName != "v1.0.7" && tagName != "1.0.7") {
                            _updateCheckStatus.value = "New update available: $tagName"
                        } else {
